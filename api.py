...
combined_model = CombinedModel(decoder=combined_decoder)
combined_model.load_state_dict(torch.load('final_models/combined_model.pt', map_location='cpu'))
# , strict=False)
...
def test_post(image : UploadFile = File(...)):
    ...
    image_model_loaded.load_state_dict(torch.load('final_models/image_model.pt', map_location='cpu'))
